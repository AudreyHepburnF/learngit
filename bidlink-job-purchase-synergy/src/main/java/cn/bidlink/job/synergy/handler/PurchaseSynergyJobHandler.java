...
//                String ip = properties.getProperty("purchase.synergy.old.ip");
//                String port = properties.getProperty("purchase.synergy.old.port");
//                StringBuffer sb = new StringBuffer();
//                String url = sb.append(ip).append(":").append(port).append("/synPurchase?startTime=").append(startTime.getTime()).append("&endTime=").append(endTime.getTime()).toString();
...
//                }
//            } catch (Exception e) {
//                logger.error("5.采购商：关闭连接，释放资源发生错误。", e);
//            }
//        }
//    }
//
