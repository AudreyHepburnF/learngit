 ...
 */
@Service
@JobHander("syncPurchaseStatusProcessStatJobHandler")
public class SyncPurchaseStatusProcessStatJobHandler extends SyncJobHandler/* implements InitializingBean*/ {

    private Logger logger = LoggerFactory.getLogger(SyncPurchaseStatusProcessStatJobHandler.class);
    ...
    protected String getTableName() {
        return "purchase_status_process_stat";
    }
